...
<form class="form__content" action="{{ route('subscribe', app()->getLocale()) }}" method="POST">
    ...
    <div class="form__wrap">
        <div class="col-12 d-flex flex-column">
            ...
            <textarea class="form__textarea" name="question_1"></textarea>
            @error('question_1')
        ...
        <div class="col-12 d-flex flex-column">
            ...
            <textarea class="form__textarea" name="question_2"></textarea>
            @error('question_2')
            <p class="text-danger mt-2"> {{ $message }}</p>
            @enderror
        </div>
        <div class="col-12 d-flex flex-column">
            ...
            <textarea class="form__textarea" name="question_3"></textarea>
            @error('question_3')
            <p class="text-danger mt-2"> {{ $message }}</p>
            @enderror
        </div>
        <div class="col-12 d-flex flex-column">
            ...
            <div class="d-flex label__checkbox">
                <label class="me-5 d-flex align-items-center"><input class="me-3 input__checkbox" type="checkbox" name="question_4" value="1">{{__('Ja')}}</label>
                <label class="d-flex align-items-center"><input class="me-3 input__checkbox" type="checkbox" name="question_4" value="0">{{{__('Neen')}}}</label>
            </div>
            @error('question_4')
            <p class="text-danger mt-2"> {{ $message }}</p>
            @enderror
        ...
        <div class="row">
            <div class="col-12 col-lg-6 custom__margin">
                <h4>{{__('Voornaam *')}}</h4>
                <input class="input__style" type="text" name="first_name">
                @error('first_name')
                <p class="text-danger mt-2"> {{ $message }}</p>
                @enderror
            </div>
            <div class="col-12 col-lg-6 custom__margin">
                <h4>{{__('Naam *')}}</h4>
                <input class="input__style" type="text" name="last_name">
                @error('last_name')
                <p class="text-danger mt-2"> {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="col-12 custom__margin">
                ...
                <input class="input__style" type="text" name="email">
                @error('email')
                <p class="text-danger mt-2"> {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="col-12 col-lg-6 custom__margin">
                ...
                <input class="input__style " type="number" name="telephone">
                @error('telephone')
                <p class="text-danger mt-2"> {{ $message }}</p>
                @enderror
            </div>
            <div class="col-12 col-lg-6 custom__margin">
                ...
                <input class="input__style" type="text" name="company">
                @error('company')
                <p class="text-danger mt-2"> {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="col-12 col-lg-6">
                <input class="input__style" type="number" name="tiebreaker_question">
